...
namespace QLDiemSV.DAO
{
    public class GiangVienDAO
    {
        ...
        public List<GiangVien> LayDSGiangVien()
        {
            ...
            var rows = dh.FillDataTable("select * from tblGIANG_VIEN").Rows;
        ...
        {
            List<GiangVien> lgv = new List<GiangVien>();
            dt = dh.FillDataTable("select * from tblGIANG_VIEN Where MaKhoa = '" + maKhoa + "'");
        ...
        public void ThemGV(GiangVien gv)
        {
            ...
            dh.UpdateDataTableToDatabase(dt, "tblGIANG_VIEN");
        }
